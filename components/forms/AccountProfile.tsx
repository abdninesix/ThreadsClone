...
interface Props {user: {id:string, objectId:string, username:string, name:string, bio:string, image:string}, btnTitle:string}
  ...
  const onSubmit = async (values: z.infer<typeof userValidation>) => {
    ...
    if (hasImageChanged){
      ...
      if (imgRes && imgRes[0].fileUrl) {
        ...
        console.error("File URL not found in the response", imgRes);
    }
    }
