...
const ThreadCard = ({id, currentUserId, parentId, content, author, community, createdAt, comment, isComment}: Props) => {
    return (
                    ...
                    <div className="flex w-full flex-col">
                        ...
                        <div className={`${isComment && 'mb-10'} mt-5 flex flex-col gap-3`}>
                            <div className="flex gap-3.5">
                                ...
                                <Link href={`/thread/${id}`} ><Image src="/assets/reply.svg" alt="heart" width={24} height={24} className="cursor-pointer object-contain"/></Link>                                
                            ...
                            <Link href={`/thread/${id}`}><p className="mt-1 text-subtle-medium text-gray-1">{comment.length}Replies</p></Link> )}
                        </div>
                    </div>
                </div>
            </div>
